...
class Structured_Perceptron(object):
    def __init__(self, train, test):
        ...
        self.no_of_tags = 10;
        self.f_len = [1,2,2,201,201];
        self.total_feature_sp = sum(self.f_len);
        self.f_loc = [0,1,3,5,206];
...
if __name__ == '__main__':
  ...
  # train_size = 100;
  # while train_size <= 1001:
  #    f.write("Train Size " + str(train_size));
  #=============================================================================
  train_size = 1000;
  print str(train_size);
  io = IO(args[0], train_size, 1000)
  perceptron = Structured_Perceptron(io.train, io.test);
...
#===============================================================================
# f.write(" Train " + str(perceptron.computeAvgError(io.train, learnt_weights)));
# f.write(" Test " +  str(perceptron.computeAvgError(io.test, learnt_weights)));
# f.write("\n")
